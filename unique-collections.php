...
<div class="section-hero">
  ...
  <p>Exclusive designs that showcase exceptional craftsmanship and artistry</p>
  <a href="products.php" class="btn-all-products">Browse All Products</a>
</div>

<div class="section-content">
  <?php if (empty($uniqueCollections)): ?>
    <div class="no-products">
      <h3>Coming Soon</h3>
      <p>Unique collection products will appear here when added by admin</p>
      <a href="products.php" class="btn-all-products">Browse All Products</a>
    </div>
  <?php else: ?>
    <div class="products-grid">
      <?php foreach ($uniqueCollections as $product): 
        ...
        <div class="product-card">
          <div class="product-image-box <?php echo empty($product['image']) ? 'no-image' : ''; ?>">
            ...
            <?php else: ?>
              💎
            <?php endif; ?>
            <div class="unique-badge">✨ UNIQUE</div>
          </div>
